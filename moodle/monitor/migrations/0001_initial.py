# Generated by Django 2.2 on 2020-03-03 16:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitor.Site_User')),
            ],
        ),
        migrations.CreateModel(
            name='SurveyQuestion',
        ...
        migrations.AddField(
            model_name='group',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groupings', to='monitor.Site_User'),
        ),
        migrations.AddField(
            model_name='group',
            name='skill',
